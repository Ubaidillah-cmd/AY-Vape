  ...
  <div class="container">
    ...
    <div class="cart-layout">
      ...
      <div class="summary-card fade-up-2">
        ...
        <a href="../customer/checkout.php" class="btn btn-primary btn-full" style="margin-top:20px;">
          Checkout Sekarang →
        </a>

        <a href="../public/index.php" class="btn btn-secondary btn-full" style="margin-top:10px;">
          ← Lanjut Belanja
        </a>
      </div>
    ...
    <div class="card empty-cart fade-up">
      ...
      <a href="../public/index.php" class="btn btn-primary">Mulai Belanja →</a>
    </div>
    <?php endif; ?>
